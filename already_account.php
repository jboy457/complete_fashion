...
<form action="already_account.php" method="POST">
  ...
  <div style="background-image: url(77.jpg);" class="right">
    ...
    <button class="social-signin facebook" ><a  href="https://www.facebook.com" style="text-decoration: none;">Log in with facebook</a></button>
    <button class="social-signin twitter"><a href="https://www.twitter.com" style="text-decoration: none;">Log in with Twitter</a></button>
    <button class="social-signin google"><a href="https://accounts.google.com/servicelogin" style="text-decoration: none;">Log in with Google+</a></button>  </div>
  <div class="or">OR</div>
    </div>
</form>    
