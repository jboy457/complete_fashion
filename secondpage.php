...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    ...
    <a><div class="w3-quarter">
      <img src="b2.jpg" alt="Salmon" style="width:100%">
      <h3>Salmon For Your Skin, A nice Office wear.</h3>
      <p>Price: $100.</p>
    </div></a>
    <a><div class="w3-quarter">
      <img src="t1.jpg" alt="Sandwich" style="width:100%">
      <h3>The Perfect Sandwich, A Real Classic Skirt</h3>
      <p>Price: $50</p>
    </div></a>
    <a><div class="w3-quarter">
      <img src="s2.jpg" alt="Croissant" style="width:100%">
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      <a href="firstpage.php" class="w3-bar-item w3-button w3-hover-black">«</a>
      ...
      <a href="thirdpage" class="w3-bar-item w3-button w3-hover-black">»</a>
    </div>
  </div>
