...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:20%;min-width:250px;" id="mySidebar">
  ...
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Ankara</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Male Office Wears</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Female Office Wears</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Wedding Gowns</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">T-Shirts and Tops</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Other wears</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Gowns</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Shoes</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Sandals</a>
  <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">African cloths</a>
   <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Bags</a>
    <a href="#.php" onclick="w3_close()" class="w3-bar-item w3-button">Wrist-Watch</a>
</nav>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    <a><div class="w3-quarter">
      <img src="s6.jpg" alt="completefashion" style="width:100%">
      <h3>The Perfect Sandwich, A Real and Nice Office Shoe</h3>
      <p>Price: $450</p>
    </div></a>
    <a><div class="w3-quarter">
      <img src="h4.png" alt="completefashion" style="width:100%">
      <h3>Let Me Tell You About This nice hair</h3>
      <p>Price: $180</p>
    </div></a>
    <a><div class="w3-quarter">
      <img src="t3.jpg" alt="completefashion" style="width:100%">
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      <a href="thirdpage.php" class="w3-bar-item w3-button w3-hover-black">«</a>
      ...
      <a href="foirthpage.php" class="w3-bar-item w3-button  w3-black ">4</a>
